locals {
  bucket_name     = "csandquist-sandbox-ecs-trigger"
  event_bus_name  = "default"
  container_image = "741448928264.dkr.ecr.us-east-1.amazonaws.com/sandbox:hello-world"
  ecs_subnet_id   = "subnet-0b6a92bc74cf6f436"
  region          = "us-east-1"
